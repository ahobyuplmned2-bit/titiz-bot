...
PROTECTED_GROUPS = {
    ...
    "عصارة البصل الفريدة الأصلية": {
        "price": "1500",
        "products": {
            "عصارة البصل الفريدة الأصلية": "onion-chopper-almafada.jpg",
        },
    },
    "ممهَد فول استيل أصلي": {
        "price": "500",
        "products": {
            "ممهَد فول استيل أصلي": "steel-fava-masher.jpg",
        },
    },
    "مطابع كعك ومعمول أبو 10 نقشات": {
        "price": "1200",
        "products": {
            "مطابع كعك ومعمول أبو 10 نقشات": "kaak-maamoul-mold-10-patterns.jpg",
        },
    },
    "معاجن استيل": {
        "price": "1000",
        "products": {
            "معاجن استيل": "steel-dough-bowls-5-sizes.jpg",
        },
    },
    "كتالي أبيض من منتجات الدار": {
        "price": "2500",
        "products": {
            "كتالي أبيض من منتجات الدار": "al-dar-white-ktali.jpg",
        },
    },
}
