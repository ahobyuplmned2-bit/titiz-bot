...
RESPONSES = {
    ...
    "ايش تبيعو": RESPONSES["1"],
    "وش تبيعون": RESPONSES["1"],
    "وش تبيعوا": RESPONSES["1"],
    "وش تبيعو": RESPONSES["1"],
    "شو تبيعون": RESPONSES["1"],
    "شو تبيعوا": RESPONSES["1"],
    "شو تبيعو": RESPONSES["1"],
    "ايش منتجاتكم": RESPONSES["1"],
    "وش منتجاتكم": RESPONSES["1"],
    "شو منتجاتكم": RESPONSES["1"],
    "ايش بضاعتكم": RESPONSES["1"],
    "وش بضاعتكم": RESPONSES["1"],
    "ايش فيه": RESPONSES["1"],
    "ايش في": RESPONSES["1"],
    "ايش الموجود": RESPONSES["1"],
    "ايش المتوفر": RESPONSES["1"],
    "وش الموجود": RESPONSES["1"],
    "وش المتوفر": RESPONSES["1"],
    "المتوفر": RESPONSES["1"],
    "الموجود": RESPONSES["1"],
    "ابي اشوف": RESPONSES["1"],
    "ابي اشوف المنتجات": RESPONSES["1"],
    "اشتي اشوف": RESPONSES["1"],
    "اشتي اشوف المنتجات": RESPONSES["1"],
    "اريد اشوف": RESPONSES["1"],
    "اريد اشوف المنتجات": RESPONSES["1"],
    "بدي اشوف": RESPONSES["1"],
    "بدي اشوف المنتجات": RESPONSES["1"],
    "ابغى اشوف": RESPONSES["1"],
    "ابغى اشوف المنتجات": RESPONSES["1"],
    "ورني": RESPONSES["1"],
    "ورني المنتجات": RESPONSES["1"],
    "ورني البضاعه": RESPONSES["1"],
    "وريني": RESPONSES["1"],
    "وريني المنتجات": RESPONSES["1"],
    "عندكم شي": RESPONSES["1"],
    "عندكم اشياء": RESPONSES["1"],
    "ايش عندك": RESPONSES["1"],
    "وش عندك": RESPONSES["1"],
    "ايش معاك": RESPONSES["1"],
    "وش معاك": RESPONSES["1"],
    "ايش تبيع": RESPONSES["1"],
    "وش تبيع": RESPONSES["1"],
    "تبيعون ايش": RESPONSES["1"],
    "تبيعوا ايش": RESPONSES["1"],
    "الاسعار": RESPONSES["1"],
    "الأسعار": RESPONSES["1"],
    "اسعار": RESPONSES["1"],
    "أسعار": RESPONSES["1"],
    ...
    "كم الأسعار": RESPONSES["1"],
    "بكم": RESPONSES["1"],
    "اسعاركم": RESPONSES["1"],
    "أسعاركم": RESPONSES["1"],
    "كم سعر": RESPONSES["1"],
    "كم اسعار": RESPONSES["1"],
    "قائمة المنتجات": RESPONSES["1"],
    "قائمه المنتجات": RESPONSES["1"],
    "كتالوج": RESPONSES["1"],
    "الكتالوج": RESPONSES["1"],
    # === الموقع ===
