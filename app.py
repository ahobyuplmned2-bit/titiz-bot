...
# ردود التحية - كل تحية لها رد خاص
MENU_HINT = "\n\n🍲 اكتبي *قدور* لتشوفي طقم القدور\n☕ اكتبي *ثلاجة* لتشوفي ثلاجة الشاي\n📜 أو أرسلي *1* لكل المنتجات\n\n🚚 التوصيل *مجاني* 💳 الدفع عند الاستلام\n💡 *الكمية محدودة والطلب كثير!*"

RESP_SALAM = "وعليكم السلام ورحمة الله 🤲✨\nنورتينا يا غالية! بايش نخدمكِ؟ ايش نقدم لكِ من منتجات؟ 😍" + MENU_HINT
RESP_HALA = "هلا وغلا فيكِ! 💛✨\nنورتي والله! بايش نخدمكِ اليوم؟ 😊" + MENU_HINT
RESP_MARHABA = "مرحباً فيكِ يا حلوة! 🌸✨\nأهلاً وسهلاً! ايش تبين تشوفين من منتجاتنا؟ 😍" + MENU_HINT
RESP_SABAH = "صباح النور والسعادة! ☀️🌺\nيسعد صباحكِ! بايش نخدمكِ اليوم؟ 😊" + MENU_HINT
RESP_MASA = "مساء النور والورد! 🌙✨\nأهلاً فيكِ! ايش نقدم لكِ هالمساء؟ 😍" + MENU_HINT
RESP_KAIF = "الحمد لله بخير! الله يسعدكِ 😊💛\nبايش نقدر نخدمكِ اليوم؟" + MENU_HINT
RESP_AFYA = "الله يعافيكِ يا قلبي! 🙏💛\nنورتينا! بايش نخدمكِ؟ 😊" + MENU_HINT
RESP_AHLAN = "أهلين فيكِ! 💛✨\nحياكِ الله! ايش تحبين تشوفين؟ 😍" + MENU_HINT
RESP_HAI = "هايي! 👋😊\nأهلاً فيكِ! بايش نقدر نساعدكِ؟ 💛" + MENU_HINT
RESP_SHUKR = "العفو يا غالية! 🙏✨\nإحنا في خدمتكِ دائماً! هل تبين شي ثاني؟ 😊" + MENU_HINT
