...
SEARCH_SPELLING_CORRECTIONS = {
    ...
    # صيغ شعبية شائعة لأدوات الشاي: تبقى محصورة في فئة الكلمة المقصودة.
    "قلاصات": "اقلاص", "قلاسات": "اقلاص", "اقلاصات": "اقلاص",
    "كتال": "كتلي", "كتالي": "كتلي", "كتل": "كتلي",
}
...
add_response(
    ...
    "وعليكم السلام ورحمة الله وبركاته! كيف يمكنني مساعدتك اليوم في رحلة البحث الخاصة بك عبر Titiz؟ سواء كنت تبحث عن منتجات جديدة ومحلات موثوقين، أنا هنا لخدمتك."
)
...
add_response(
    ...
    "أنا بخير وبأتم الاستعداد لمساعدتك! شكرًا لسؤالك.\n\nبصفتي مساعدك في Titiz، يمكنني مساعدتك في العثور على أفضل المنتجات بل جملة وتجزئة. كيف يمكنني خدمتك اليوم؟ هل تبحث عن منتج معين؟"
)
